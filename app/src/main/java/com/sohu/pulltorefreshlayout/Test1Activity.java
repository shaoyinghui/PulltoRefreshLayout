...
public class Test1Activity extends AppCompatActivity implements RefreshableLayout.IOnHeaderRefreshListener, RefreshableLayout.IOnfootRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRefreshView= (RefreshableLayout) findViewById(R.id.id_pull);
    ...
    private void initData() {
        ...
        mAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, android.R.id.text1, datas){
            ...
            public String getItem(int position) {
                return "item "+datas.get(position);
            }
        };
    ...
    public void onHeaderRefresh(final RefreshableLayout view) {
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(Test1Activity.this, "刷新完成", Toast.LENGTH_SHORT).show();
