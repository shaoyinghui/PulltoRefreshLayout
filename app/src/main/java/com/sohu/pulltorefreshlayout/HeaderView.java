...
import com.sohu.pulltorefreshlayout.common.HeaderViewChangedListener;

/**
 * Created by shaoyinghui on 2016/10/18.
 */
...
public class HeaderView extends ViewGroup {
    ...
    protected RefreshableLayout mLayout;
    ...
    HeaderViewChangedListener mOnHeaderViewChangedListener;
    ...
    public HeaderView(Context context, RefreshableLayout layout) {
        super(context);
        mLayoutView = layout;
